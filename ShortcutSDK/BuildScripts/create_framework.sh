...
lipo -create -output "${BUILT_PRODUCTS_DIR}/lib${PROJECT_NAME}.a.fat" "${BUILT_PRODUCTS_DIR}/build-arm64/lib${PROJECT_NAME}.a" "${BUILT_PRODUCTS_DIR}/build-x86_64/lib${PROJECT_NAME}.a"
