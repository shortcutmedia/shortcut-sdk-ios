...
@implementation KSCDictionaryUtils
...
{
	NSString* result = [KSCDictionaryUtils objectFromDictionary:dictionary withClass:[NSString class] atPath:path];
	return result;
}

+ (NSNumber*)numberFromDictionary:(NSDictionary*)dictionary atPath:(NSString*)path
{
	NSNumber* result = [KSCDictionaryUtils objectFromDictionary:dictionary withClass:[NSNumber class] atPath:path];
	return result;
}

+ (NSArray*)arrayFromDictionary:(NSDictionary*)dictionary atPath:(NSString*)path
{
	NSArray* result = [KSCDictionaryUtils objectFromDictionary:dictionary withClass:[NSArray class] atPath:path];
	return result;
}

+ (NSDictionary*)dictionaryFromDictionary:(NSDictionary*)dictionary atPath:(NSString*)path
{
	NSDictionary* result = [KSCDictionaryUtils objectFromDictionary:dictionary withClass:[NSDictionary class] atPath:path];
	return result;
}
