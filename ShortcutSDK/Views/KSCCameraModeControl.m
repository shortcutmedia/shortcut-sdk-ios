...
@interface KSCCameraModeControl (/* Private */)
...
- (CGRect)sliderRectForMode:(KSCCameraMode)mode;
- (void)switchModes;

@end


@implementation KSCCameraModeControl
...
- (void)awakeFromNib
{
	...
	NSString* sliderBackroundImagePath = [[KSCSDKConfig SDKBundle] pathForResource:@"CameraModeSliderBackground" ofType:@"png"];
	...
	NSString* singleShotPath = [[KSCSDKConfig SDKBundle] pathForResource:@"CameraModeSingleShotIcon" ofType:@"png"];
	...
	NSString* liveIconPath = [[KSCSDKConfig SDKBundle] pathForResource:@"CameraModeLiveScannerIcon" ofType:@"png"];
	...
	NSString* sliderPath = [[KSCSDKConfig SDKBundle] pathForResource:@"CameraModeSlider" ofType:@"png"];
...
- (void)setCameraMode:(KSCCameraMode)mode
{
	cameraMode = mode;
	[self setNeedsLayout];
}
